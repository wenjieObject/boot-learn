...
在Idea的右侧Maven侧边栏的项目目录，Lifecycle下的package双击打包

![image-20200801090955294](C:\Users\wenjiejiang\AppData\Roaming\Typora\typora-user-images\image-20200801090955294.png)

在项目目录的target下会生成可执行的jar包

将这个应用打成jar包，直接使用（java -jar 包名）的命令进行执行；
